import type { Zone, Employee } from '@/types/cleaning'

export const EQUIPE_LIMPEZA: Employee[] = [
...
export const CATALOGO_ZONAS: Zone[] = [
  {
    id: 'ZONA-01', nome: 'Estoque / Expedição', icone: '📦',
    setor: 'Logística', riskLevel: 'high',
    descricao: 'Área de armazenamento de produtos acabados e expedição.',
    responsaveis: ['LIMP-001', 'LIMP-002'],
    sections: [
      {
        id: 'z1_seiri', nome: 'S1 — Seiri · Utilização',
        items: [
      ...
      {
        id: 'z1_seiton', nome: 'S2 — Seiton · Organização',
        items: [
      ...
      {
        id: 'z1_seiso', nome: 'S3 — Seiso · Limpeza',
        items: [
      ...
      {
        id: 'z1_seiketsu', nome: 'S4 — Seiketsu · Padronização',
        items: [
      ...
      {
        id: 'z1_shitsuke', nome: 'S5 — Shitsuke · Disciplina',
        items: [
  ...
  {
    id: 'ZONA-02', nome: 'Maquinários / Chão de Fábrica', icone: '⚙️',
    setor: 'Produção', riskLevel: 'critical',
    descricao: 'Chão de fábrica e entorno dos equipamentos de produção.',
    responsaveis: ['LIMP-003'],
    sections: [
      {
        id: 'z2_seiri', nome: 'S1 — Seiri · Utilização',
        items: [
      ...
      {
        id: 'z2_seiton', nome: 'S2 — Seiton · Organização',
        items: [
      ...
      {
        id: 'z2_seiso', nome: 'S3 — Seiso · Limpeza',
        items: [
      ...
      {
        id: 'z2_seiketsu', nome: 'S4 — Seiketsu · Padronização',
        items: [
      ...
      {
        id: 'z2_shitsuke', nome: 'S5 — Shitsuke · Disciplina',
        items: [
  ...
  {
    id: 'ZONA-03', nome: 'Insumos / Matérias-Primas', icone: '🌾',
    setor: 'Recebimento', riskLevel: 'critical',
    descricao: 'Área de recebimento e armazenamento de matérias-primas.',
    responsaveis: ['LIMP-004'],
    sections: [
      {
        id: 'z3_seiri', nome: 'S1 — Seiri · Utilização',
        items: [
      ...
      {
        id: 'z3_seiton', nome: 'S2 — Seiton · Organização',
        items: [
      ...
      {
        id: 'z3_seiso', nome: 'S3 — Seiso · Limpeza',
        items: [
      ...
      {
        id: 'z3_seiketsu', nome: 'S4 — Seiketsu · Padronização',
        items: [
      ...
      {
        id: 'z3_shitsuke', nome: 'S5 — Shitsuke · Disciplina',
        items: [
  ...
  {
    id: 'ZONA-04', nome: 'Áreas de Apoio', icone: '🚻',
    setor: 'Facilities', riskLevel: 'medium',
    descricao: 'Banheiros, refeitório, almoxarifado e oficina.',
    responsaveis: ['LIMP-001', 'LIMP-002', 'LIMP-003', 'LIMP-004'],
    sections: [
      {
        id: 'z4_seiri', nome: 'S1 — Seiri · Utilização',
        items: [
      ...
      {
        id: 'z4_seiton', nome: 'S2 — Seiton · Organização',
        items: [
      ...
      {
        id: 'z4_seiso', nome: 'S3 — Seiso · Limpeza',
        items: [
      ...
      {
        id: 'z4_seiketsu', nome: 'S4 — Seiketsu · Padronização',
        items: [
      ...
      {
        id: 'z4_shitsuke', nome: 'S5 — Shitsuke · Disciplina',
        items: [
...
export const ZONE_MAP = new Map(CATALOGO_ZONAS.map(z => [z.id, z]))
export const EMPLOYEE_MAP = new Map(EQUIPE_LIMPEZA.map(e => [e.id, e]))
